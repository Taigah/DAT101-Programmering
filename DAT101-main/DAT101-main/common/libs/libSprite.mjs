...
/**
 * @library libSprite
 * @description A library for classes that manage sprite animation.
 */
...
class TSpriteCanvas {
    ...
    constructor(aCanvas) {
        ...
        this.#img = new Image(); // new brukes for å lage en ny forekomst av en klasse
    }

    loadSpriteSheet(aFileName, aLoadedFunction){
        this.#img.onload = aLoadedFunction;
...
export default {
    /**
     * @class TSpriteCanvas
     * @description A class that manages sprite canvas for loading sprite sheets.
     ...
     * @param {function} aLoadedFunction - The callback function to call when the image is done loading.
     */
